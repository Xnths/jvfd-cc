    ...
    return (
        <main className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <div className="prose prose-slate max-w-none text-slate-700">
                ...
                <p className="mb-4">
                    Para questões relacionadas a estes termos, entre em contato através do e-mail: <a href="mailto:joao@psicologojoaofernandes.com" className="text-blue-600 hover:underline">joao@psicologojoaofernandes.com</a>.
                </p>
