        ...
        <div className="mt-16 space-y-12">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 text-center">
                ...
                <a
                    ...
                    onClick={handleClick}
                    className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-md text-lg font-bold transition-all shadow-lg hover:shadow-green-500/20"
                >
